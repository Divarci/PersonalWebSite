    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "06/09/2023", "February 2023", true, "Udemy Course", (short)1, 1, "Step by Step C#", null },
                    { 2, "06/09/2023", "March 2023", true, "Udemy Course", (short)2, 1, "Ms SQL with querries", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "06/09/2023", "April 2023", true, false, "Udemy Course", (short)1, 2, "ASP.NET Framework MVC5", null },
                    { 4, "06/09/2023", "May 2023", true, false, "Udemy Course", (short)2, 2, "ASP.NET Core 6 MVC", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "06/09/2023", "2005 - 2010", true, "YILDIZ TECHNICAL UNIVERSITY", (short)1, 1, "ARCHITECTURE", null },
                    { 2, "06/09/2023", "2001 - 2005", true, "ATATURK HIGH SCHOOL", (short)2, 1, "SCIENCE AND MATH", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "06/09/2023", "2005 - 2010", true, false, "YILDIZ TECHNICAL UNIVERSITY", (short)1, 2, "ARCHITECTURE", null },
                    { 4, "06/09/2023", "2001 - 2005", true, false, "ATATURK HIGH SCHOOL", (short)2, 2, "SCIENCE AND MATH", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "06/09/2023", "February 2023 - Present", true, "Freelance, London", (short)1, 1, "Trainee Software Developer", null },
                    { 2, "06/09/2023", "April 2019 - Present", true, "B&H Design Ltd, London", (short)2, 1, "Architect (Director)", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "06/09/2023", "July 2011 - April 2019", true, false, "Gul-Na Architecture, Turkey", (short)1, 2, "Architect (Director)", null },
                    { 4, "06/09/2023", "June 2010 - June 2011", true, false, "Engiz Architecture, Turkey", (short)2, 2, "Architectural Assistant", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "06/09/2023", "As a recent graduate in architecture with a passion for technology, I am excited to begin a new journey in the field of coding. Despite my lack of professional experience in this field.", "Hasan Divarci", true, "Add Pcture", "Add Pcture", 1, null, "https://youtu.be/RKKoABC31zk'" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, "06/09/2023", "As a recent graduate in architecture with a passion for technology, I am excited to begin a new journey in the field of coding. Despite my lack of professional experience in this field.", "Hasan Divarci", true, false, "Add Pcture", "Add Pcture", 2, null, "https://youtu.be/RKKoABC31zk'" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "06/09/2023", "Welcome to the My Study Projects category. ", "adanali@adamlar.geldi", false, 1, "Melih Canatan", "Deneme Mesaji", null },
                    { 2, "06/09/2023", "Welcome to the My Study Projects category2. ", "mallar@adamlar.geldi", false, 1, "Tarik Canatan", "Deneme Mesaji 2", null },
                    { 3, "06/09/2023", "Welcome to the My Study Projects category3. ", "antalyali@adamlar.geldi", false, 2, "Kazim Canatan", "Deneme Mesaji 3", null },
                    { 4, "06/09/2023", "Welcome to the My Study Projects category4. ", "bursali@adamlar.geldi", false, 2, "Veli Canatan", "Deneme Mesaji 4", null }
                });

            migrationBuilder.InsertData(
                table: "ProjectCategories",
                columns: new[] { "Id", "CreatedDate", "Description", "IsPublished", "ResumeId", "Title", "UpdatedDate" },
                values: new object[] { 1, "06/09/2023", "Welcome to the My Study Projects category. ", true, 1, "Study", null });

            migrationBuilder.InsertData(
                table: "ProjectCategories",
                columns: new[] { "Id", "CreatedDate", "Description", "IsEdited", "IsPublished", "ResumeId", "Title", "UpdatedDate" },
                values: new object[] { 2, "06/09/2023", "Welcome to the Real-World Projects category, where I present a series of practical.", true, false, 2, "Real", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "06/09/2023", true, 1, "C# Coding Language", null, (byte)65 },
                    { 2, "06/09/2023", true, 1, "Asp.Net Core 6 Mvc", null, (byte)85 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "06/09/2023", true, false, 2, "HTML", null, (byte)45 },
                    { 4, "06/09/2023", true, false, 2, "CSS", null, (byte)65 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "20 Cosmopolitan Court, 67 Main Avenue, Enfield, EN1 1GD", "06/09/2023", "hasan@gmail.com", "1", "0785463212540", null },
                    { 2, 2, "44 Dowsett Road, Manchester, N17 9DD", "06/09/2023", "hasan@gmail.com", "2", "0785463212540", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 8, 3, "06/09/2023", 180, 12, null },
                    { 2, 2, 10, 2, "06/09/2023", 120, 15, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "06/09/2023", "https://github.com/", "https://linkdin.com/", "https://twitter.com/", null, "https://youtube.com/" },
                    { 2, 2, "06/09/2023", "https://github.com/", "https://linkdin.com/", "https://twitter.com/", null, "https://youtube.com/" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "06/09/2023", "Add New File", "Add New File", 1, null },
                    { 2, "06/09/2023", "Add New File", "Add New File", 1, null },
                    { 3, "06/09/2023", "Add New File", "Add New File", 2, null },
                    { 4, "06/09/2023", "Add New File", "Add New File", 2, null },
                    { 5, "06/09/2023", "Add New File", "Add New File", 3, null },
                    { 6, "06/09/2023", "Add New File", "Add New File", 3, null },
                    { 7, "06/09/2023", "Add New File", "Add New File", 4, null },
                    { 8, "06/09/2023", "Add New File", "Add New File", 4, null }
                });
