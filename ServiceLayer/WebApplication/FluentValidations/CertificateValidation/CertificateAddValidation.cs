...
namespace ServiceLayer.WebApplication.FluentValidations.CertificateValidation
{
    public class CertificateAddValidation : AbstractValidator<CertificateAddVM>
    {
        public CertificateAddValidation()
        {
            RuleFor(x => x.Title)
