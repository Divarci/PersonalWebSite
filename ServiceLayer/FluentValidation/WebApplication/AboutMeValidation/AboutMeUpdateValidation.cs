...
namespace ServiceLayer.FluentValidation.WebApplication.AboutMeValidation
{
    public class AboutMeUpdateValidation : AbstractValidator<AboutMeUpdateVM>
    {
        public AboutMeUpdateValidation()
        {
