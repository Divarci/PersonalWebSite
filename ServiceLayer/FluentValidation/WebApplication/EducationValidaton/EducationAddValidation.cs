...
namespace ServiceLayer.FluentValidation.WebApplication.EducationValidaton
{
    public class EducationAddValidation : AbstractValidator<EducationAddVM>
    {
        public EducationAddValidation()
        {
            RuleFor(x => x.Title)
