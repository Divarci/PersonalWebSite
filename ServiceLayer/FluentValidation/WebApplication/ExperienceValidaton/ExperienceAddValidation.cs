...
namespace ServiceLayer.FluentValidation.WebApplication.ExperienceValidaton
{
    public class ExperienceAddValidation : AbstractValidator<ExperienceAddVM>
    {
        public ExperienceAddValidation()
        {
            RuleFor(x => x.Title)
